...
//   final style;
//   final pathfile;
//   const PinchPage({Key? key,required this.style,required this.pathfile}) : super(key: key);
//
//   @override
...
//        document: widget.style == 'url' ?
//        PdfDocument.openData(InternetFile.get(widget.pathfile),)
//            : PdfDocument.openFile(widget.pathfile),
...
//           //             PdfDocument.openAsset('assets/pdf/hello.pdf'));
//           //         _showing = DocShown.hello;
//           //         break;
//           //       case DocShown.hello:
//           //         _pdfControllerPinch
//           //             .loadDocument(PdfDocument.openAsset('assets/pdf/hello.pdf'));
