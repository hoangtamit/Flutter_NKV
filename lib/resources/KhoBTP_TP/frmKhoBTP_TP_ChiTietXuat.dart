...
class frmKhoBTP_TP_ChiTietXuat extends StatefulWidget {
  final KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetXuat tb;
  const frmKhoBTP_TP_ChiTietXuat({
    super.key,
    required this.tb,
  });
  @override
  _frmKhoBTP_TP_ChiTietXuatState createState() => _frmKhoBTP_TP_ChiTietXuatState();
}

class _frmKhoBTP_TP_ChiTietXuatState extends State<frmKhoBTP_TP_ChiTietXuat> {
  late KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetXuat chitiet;
  List<tbl_KhoBTP_TP> dsXuatKho = [];
  @override
  void initState() {
    super.initState();
    chitiet = widget.tb;
  ...
  Future<List<tbl_KhoBTP_TP>> getdsXuatKho() async {
    dsXuatKho = await KhoBTP_TPApi.KhoBTP_TP_GetIDKhuVuc_GetMaPhieu(chitiet.MaPhieu!);
    return dsXuatKho;
  }
                ...
                child: Theme(
                  ...
                  child: FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      ...
                      int TongSoLuong = data.fold(0, (sum, item) => sum + (item.SoLuongXuat ?? 0));
