...
import 'frmKhoBTP_TP_ChiTietNhap.dart';
class frmKhoBTP_TP_Nhap extends StatefulWidget {
  const frmKhoBTP_TP_Nhap({super.key});
  @override
  _frmKhoBTP_TP_NhapState createState() => _frmKhoBTP_TP_NhapState();
}

class _frmKhoBTP_TP_NhapState extends State<frmKhoBTP_TP_Nhap> {
  List<KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetNhap> dsTonKho = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Phiếu Nhập Kho BTP TP'),
        centerTitle: true,
        actions: [
          IconButton(
      ...
      body: FutureBuilder<List<KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetNhap>>(
        future: KhoBTP_TPApi.KhoBTP_TP_GroupByMaPhieu_GetNhap(),
...
class RenderSearchableList extends StatelessWidget {
  final List<KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetNhap> dsTonKho;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: SearchableList<KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetNhap>(
...
class ActorItem extends StatelessWidget {
  final KhoBTP_TP_GroupByMaPhieu_GetIDKhuVuc_GetNhap actor;
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => KhoBTP_TP_ChiTietNhap(tb: actor,),
                        ),
                      );
                    },
                    child: SizedBox(
