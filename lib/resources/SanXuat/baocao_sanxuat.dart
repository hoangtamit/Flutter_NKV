...
import 'package:qlsx/api/NghiepVu/donsanxuat_api.dart';
  ...
  Future<void> getCongDoan({bool iscongdoan = true}) async {
    try {
      ...
      if (dsx != null && dsx[0].CongDoanSanXuat != "" ) {
        ...
        //     if (GetisHoanThanh.isNotEmpty && GetisHoanThanh[0].isHoanThanh != '' && GetisHoanThanh[0].isHoanThanh == 'true') {
        //       thoigianbatdauController.text = fDateTime.DD_MM_YYYY_HH_MM(GetisHoanThanh[0].ThoiGian_KetThuc.toString());
        //     }
        //     if(selectedCongDoan == item) {
        //       dsBaoCao = GetisHoanThanh;
        //       break;
        //     }
        //   }
        // }
        // else {
          for (var item in CongDoanSanXuat) {
            var GetisHoanThanh = await SanXuatApi.BaoCaoSanXuat_V2_GetSCD_GetCongDoan_GroupBy(scdController.text, item);
            if (GetisHoanThanh.isEmpty)continue;
            if (!GetisHoanThanh[0].isHoanThanh || selectedCongDoan == item) {
              setState(() {
            ...
            else if (GetisHoanThanh[0].isHoanThanh != '' && GetisHoanThanh[0].isHoanThanh) {
              dsBaoCao = GetisHoanThanh;
              thoigianbatdauController.text = fDateTime.DD_MM_YYYY_HH_MM(GetisHoanThanh[0].ThoiGian_KetThuc.toString());
            }
          }
        ...
        if (dsBaoCao.length > 0) {
          ...
          setState(() {
            ...
            //soluongdatController.text = tb.SoLuongDat.toString();
            //soluongloiController.text = tb.SoLuongLoi.toString();
