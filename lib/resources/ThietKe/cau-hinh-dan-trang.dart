  ...
  void _updateValue(String key, int delta) {
    setState(() {
      ...
      _config = tbl_TemGiay_CauHinhDanTrang(
        ArtboardWidth: key == 'ArtboardWidth' ? _values[key]! : _config.ArtboardWidth,
        ArtboardHeight: key == 'ArtboardHeight' ? _values[key]! : _config.ArtboardHeight,
        ArtboardSpace: key == 'ArtboardSpace' ? _values[key]! : _config.ArtboardSpace,
        ArtboardNumber: key == 'ArtboardNumber' ? _values[key]! : _config.ArtboardNumber,
        MarginLeft: key == 'MarginLeft' ? _values[key]! : _config.MarginLeft,
        MarginRight: key == 'MarginRight' ? _values[key]! : _config.MarginRight,
        MarginBottom: key == 'MarginBottom' ? _values[key]! : _config.MarginBottom,
        MarginTop: key == 'MarginTop' ? _values[key]! : _config.MarginTop,
        Width: key == 'Width' ? _values[key]! : _config.Width,
        Height: key == 'Height' ? _values[key]! : _config.Height,
        WidthPlace: key == 'WidthPlace' ? _values[key]! : _config.WidthPlace,
        HeightPlace: key == 'HeightPlace' ? _values[key]! : _config.HeightPlace,
        RK: _config.RK,
        WidthSpace: key == 'WidthSpace' ? _values[key]! : _config.WidthSpace,
        HeightSpace: key == 'HeightSpace' ? _values[key]! : _config.HeightSpace,
        ...
        ColumnPosition: key == 'ColumnPosition' ? _values[key]! : _config.ColumnPosition,
        ColumnSpace: key == 'ColumnSpace' ? _values[key]! : _config.ColumnSpace,
        RowPosition: key == 'RowPosition' ? _values[key]! : _config.RowPosition,
        RowSpace: key == 'RowSpace' ? _values[key]! : _config.RowSpace,
        TrimMark_Length: key == 'TrimMark_Length' ? _values[key]! : _config.TrimMark_Length,
        TrimMark_Space: key == 'TrimMark_Space' ? _values[key]! : _config.TrimMark_Space,
        ...
        body: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      debugPrint('Truyền Dữ Liệu ${_config.ArtboardSpace}');
