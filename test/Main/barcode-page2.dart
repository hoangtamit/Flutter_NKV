...
class _BarcodeScannerPageState extends State<BarcodeScannerPage> {
  ...
  String? scannedCode = 'LAN-250506-1157'; // Khởi tạo là null, không cần giá trị mặc định ở đây nữa
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
              ...
              if (barcodes.isNotEmpty) {
                ...
                if (currentCode != null && currentCode.length == 15) {
                  ...
                  Future.delayed(const Duration(milliseconds: 500), () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => frmBaoCaoSanXuat(SCD: scannedCode!),),).then((_) {
          ...
          if (scannedCode != null)
            //frmBaoCaoSanXuat(SCD: scannedCode!),
            Positioned(
              top: 20,
              left: 0,
              right: 0,
